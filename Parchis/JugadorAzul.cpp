...
JugadorAzul::JugadorAzul(GameResources& resources) : recursos(resources) {}

void JugadorAzul::inicializarFichas() {
...
void JugadorAzul::dibujarFichas(sf::RenderWindow& ventana) const {
