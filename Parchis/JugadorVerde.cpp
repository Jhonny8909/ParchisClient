...
JugadorVerde::JugadorVerde(GameResources& resources) : recursos(resources) {}

void JugadorVerde::inicializarFichas() {
...
void JugadorVerde::dibujarFichas(sf::RenderWindow& ventana) const {
